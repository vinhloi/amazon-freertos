...
*                                Changed the default value of the following definition value from 10 to 12.
*                                - BSP_CFG_PLL_MUL
...
/* Clock configuration options.
   ...
   BSP_CFG_HOCO_FREQUENCY  = 2(20MHz)
   BSP_CFG_PLL_DIV  = 1        (no division)
   BSP_CFG_PLL_MUL  = 12.0     (20MHz x 12.0 = 240MHz)
...
/* There are multiple versions of the TARGETBOARDRX65N. Choose which board is currently being used below.
   0 = 1st Prototype Board (RTK5RX65N0CxxxxxBR)
*/

...
/* Clock configuration options.
   ...
   BSP_CFG_PLL_MUL  = 20.0     (12MHz x 20.0 = 240MHz)
...
/* There are multiple versions of the ENVISIONRX65N. Choose which board is currently being used below.
   0 = 1st Prototype Board (RTK5RX65N2CxxxxxBR)
*/

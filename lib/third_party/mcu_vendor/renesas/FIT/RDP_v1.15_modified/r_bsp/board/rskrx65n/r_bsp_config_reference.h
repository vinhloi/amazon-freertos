...
*         : 15.05.2017 2.00      Changed the comment of the following macro definition, because there was a mistake
*                                in package type.
*                                - BSP_CFG_MCU_PART_PACKAGE - Changed package type from LQFP to LFQFP.
*                                Changed the value of the following macro definition.
*                                - BSP_CFG_MCU_PART_GROUP - Changed the setting value of RX651.
...
*                                - BSP_CFG_CODE_FLASH_BANK_MODE
*                                - BSP_CFG_CODE_FLASH_START_BANK
*                                Added Character(s) of the following macro definition.
*                                - BSP_CFG_MCU_PART_PACKAGE - FC = 0x0 = LFQFP/176/0.50.
*                                                           - BG = 0x1 = LFBGA/176/0.80.
*                                                           - LC = 0x2 = TFLGA/177/0.50.
*                                - BSP_CFG_MCU_PART_ENCRYPTION_INCLUDED - D = false = Encryption module not included, 
*                                                                                     SDHI/SDSI module included,
*                                                                                     dual-bank structure.
*                                                                       - H = true  = Encryption module included,
*                                                                                     SDHI/SDSI module included,
*                                                                                     dual-bank structure.
*                                - BSP_CFG_MCU_PART_MEMORY_SIZE - C = 0xC = 1.5MB/640KB/32KB
*                                                                 E = 0xE = 2MB/640KB/32KB
*         : 01.12.2017 2.01      Added the following macro definition.
...
*         : 01.07.2018 2.02      Added the following macro definition.
...
/* There are multiple versions of the RSKRX65N. Choose which board is currently being used below.
   0 = 1st Prototype Board (RTK500565NCxxxxxBR)
*/

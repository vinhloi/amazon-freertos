...
*         : 01.07.2018 1.21     Prevent task switching when protection counter is updated.
*         : xx.xx.xxxx x.xx     Added processing to control IPL for R_BSP_RegisterProtectEnable function and 

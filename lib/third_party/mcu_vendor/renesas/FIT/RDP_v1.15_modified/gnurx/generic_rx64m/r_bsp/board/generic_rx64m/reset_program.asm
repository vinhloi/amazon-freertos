...
;;reset_program.asm
    ...
    .extern _bss
    .extern _edata
    .extern _Processing_Before_Start_Kernel
    .extern _vTaskStartScheduler
    .extern _main
    .extern _ustack
    .extern _istack
    .extern _rvectors
...
;;start user program
    ...
    bsr.a    _Processing_Before_Start_Kernel

    ;;Call the kernel startup (should not return)
    bsr.a    _vTaskStartScheduler
;;    bsr.a   _main
    bsr.a   _exit

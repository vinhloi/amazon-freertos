...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx63n_private.h"
...
const sci_iic_ch_rom_t g_sci_iic_ch0_rom =
{
    ...
    &ICU.IER[IER_SCI0_TXI0].BYTE, BIT7_MASK,
    &ICU.IER[IER_SCI0_TEI0].BYTE, BIT0_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch1_rom =
{
    ...
    &ICU.IER[IER_SCI1_TXI1].BYTE, BIT2_MASK,
    &ICU.IER[IER_SCI1_TEI1].BYTE, BIT3_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch2_rom =
{
    ...
    &ICU.IER[IER_SCI2_TXI2].BYTE, BIT5_MASK,
    &ICU.IER[IER_SCI2_TEI2].BYTE, BIT6_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch3_rom =
{
    ...
    &ICU.IR[IR_SCI3_TEI3].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI3_TXI3].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI3_TEI3].BYTE, BIT1_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch4_rom =
{
    ...
    &ICU.IR[IR_SCI4_TEI4].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI4_TXI4].BYTE, BIT3_MASK,
    &ICU.IER[IER_SCI4_TEI4].BYTE, BIT4_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch5_rom =
{
    ...
    &ICU.IER[IER_SCI5_TXI5].BYTE, BIT6_MASK,
    &ICU.IER[IER_SCI5_TEI5].BYTE, BIT7_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch6_rom =
{
    ...
    &ICU.IER[IER_SCI6_TXI6].BYTE, BIT1_MASK,
    &ICU.IER[IER_SCI6_TEI6].BYTE, BIT2_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch7_rom =
{
    ...
    &ICU.IR[IR_SCI7_TEI7].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI7_TXI7].BYTE, BIT4_MASK,
    &ICU.IER[IER_SCI7_TEI7].BYTE, BIT5_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch8_rom =
{
    ...
    &ICU.IER[IER_SCI8_TXI8].BYTE, BIT7_MASK,
    &ICU.IER[IER_SCI8_TEI8].BYTE, BIT0_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch9_rom =
{
    ...
    &ICU.IER[IER_SCI9_TXI9].BYTE, BIT2_MASK,
    &ICU.IER[IER_SCI9_TEI9].BYTE, BIT3_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch10_rom =
{
    ...
    &ICU.IR[IR_SCI10_TEI10].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI10_TXI10].BYTE, BIT5_MASK,
    &ICU.IER[IER_SCI10_TEI10].BYTE, BIT6_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch11_rom =
{
    ...
    &ICU.IER[IER_SCI11_TXI11].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI11_TEI11].BYTE, BIT1_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch12_rom =
{
    ...
    &ICU.IER[IER_SCI12_TXI12].BYTE, BIT3_MASK,
    &ICU.IER[IER_SCI12_TEI12].BYTE, BIT4_MASK,
...
void r_sci_iic_io_open (uint8_t port_gr, uint8_t pin_num)
{
    ...
    if (((((PORT1_GR != port_gr) && (PORT3_GR != port_gr))
        && (PORT7_GR != port_gr)) && (PORT8_GR != port_gr))
        && (PORTF_GR != port_gr))
    {
...
void r_sci_iic_int_enable (sci_iic_info_t * p_sci_iic_info)
{
    ...
    /* Sets interrupt source priority. */
    (*prom->pipr) = prom->ipr_set_val; /* Sets interrupt source priority register. */
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic0_tei_isr, VECT_SCI0_TEI0)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic0_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic1_tei_isr, VECT_SCI1_TEI1)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic1_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic2_tei_isr, VECT_SCI2_TEI2)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic2_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic3_tei_isr, VECT_SCI3_TEI3)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic3_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic4_tei_isr, VECT_SCI4_TEI4)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic4_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic5_tei_isr, VECT_SCI5_TEI5)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic5_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic6_tei_isr, VECT_SCI6_TEI6)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic6_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic7_tei_isr, VECT_SCI7_TEI7)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic7_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic8_tei_isr, VECT_SCI8_TEI8)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic8_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic9_tei_isr, VECT_SCI9_TEI9)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic9_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic10_tei_isr, VECT_SCI10_TEI10)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic10_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic11_tei_isr, VECT_SCI11_TEI11)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic11_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic12_tei_isr, VECT_SCI12_TEI12)
R_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic12_tei_isr (void)
{

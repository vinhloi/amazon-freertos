...
#if 0
#define ESP8266_RESET_PORT_DDR    PORTF.PDR.BIT.B5     /*PMOD PinNo.8 */
#define ESP8266_RESET_PORT_DR     PORTF.PODR.BIT.B5    /*PMOD PinNo.8 */
...
#define ESP8266_RESET_PORT_DDR    PORT2.PDR.BIT.B4
#define ESP8266_RESET_PORT_DR     PORT2.PODR.BIT.B4
#if (ESP8266_USE_UART_NUM == 2)
#define SCI_TX_BUSIZ_COMMAND SCI_CFG_CH10_TX_BUFSIZ
#define SCI_TX_BUSIZ_DATA
#define SCI_RX_BUSIZ_COMMAND  SCI_CFG_CH10_RX_BUFSIZ
#define SCI_RX_BUSIZ_DATA
#elif (ESP8266_USE_UART_NUM == 1)
...
#define ESP8266_RESET_PORT_DDR
#define ESP8266_RESET_PORT_DR
#if (ESP8266_USE_UART_NUM == 2)
#define SCI_TX_BUSIZ_COMMAND SCI_CFG_CH10_TX_BUFSIZ
#define SCI_TX_BUSIZ_DATA
#define SCI_RX_BUSIZ_COMMAND  SCI_CFG_CH10_RX_BUFSIZ

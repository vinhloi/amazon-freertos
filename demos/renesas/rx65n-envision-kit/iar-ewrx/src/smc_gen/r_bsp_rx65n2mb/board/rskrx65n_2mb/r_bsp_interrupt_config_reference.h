...
*         : 31.01.2017 1.01_ES   Changed the name of the following macro definition, because there was a mistake
...
#if !defined(BSP_MCU_RX65N_2MB) /* In the case of 512K, 768K or 1Mbyte ROM capacity. */
